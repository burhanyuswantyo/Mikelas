        ...
        <div class="row top_tiles">
            <div class="">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="" class="btn btn-primary tambahRoleModal" data-toggle="modal" data-target="#roleModal">+ Tambah Role</a>
                                ...
                                <?php foreach ($role as $r) : ?>
                                    <tr class="even pointer">
                                        ...
                                        <td class="last text-center">
                                            ...
                                            <a href="" class="label label-success ubahRoleModal" data-toggle="modal" data-target="#roleModal" data-id="<?php echo $r['id']; ?>">Ubah</a>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="roleModalLabel">Tambah Role</h4>
            </div>
