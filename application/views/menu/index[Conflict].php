        ...
        <div class="row top_tiles">
            <div class="">
                <div class="col-sm-8">
                    ...
                    <a href="" class="btn btn-primary tambahSubMenuModal" data-toggle="modal" data-target="#subMenuModal">+ Tambah Sub Menu</a>
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($subMenu as $sm) : ?>
                                    <tr class="even pointer">
                                        ...
                                        <td class="last text-center">
                                            <a href="" class="label label-success ubahSubMenuModal" data-toggle="modal" data-target="#subMenuModal" data-id="<?php echo $sm['id']; ?>">Ubah</a>
